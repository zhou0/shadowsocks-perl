                                 ...
                                 if ($mode == 0)
                                 {
                                     ...
                                     elsif($self->{method} =~ /^chacha20/)
                                     {
                                        if ($self->{method} eq 'chacha20-ietf')
                                        {
                                           ...
                                           my $padded_decrypted_data = $decryptor->chacha20_ietf_xor_ic($padded_incoming_data,$client_iv,$decrypt_counter / 64,$key);
                                                  ...
                                                  on_read => sub 
                                                  {
                                                      ...
                                                      elsif($self->{method} =~ /^chacha20/)
                                                      {
                                                          ...
                                                          {        
                                                              ...
                                                              my $padded_encrypted_data = $encryptor->chacha20_ietf_xor_ic($padded_plain_data,$iv,$encrypt_counter / 64,$key);
